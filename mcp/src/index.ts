 ...
 *
 * Cert Atlas publishes structured, machine-readable blueprints for thousands of exams
 * across hundreds of certifying bodies — exam domains and topic weights, passing scores,
